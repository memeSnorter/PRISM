...
1. **Fork** the repository at [https://github.com/chemicoholic21/prism](https://github.com/chemicoholic21/prism)
...
5. **Make your changes**, test them, then open a Pull Request
---
...
If you're unsure where to start, look for issues tagged **`good first issue`** on the [Issues page](https://github.com/chemicoholic21/prism/issues).
...
Open an issue at [https://github.com/chemicoholic21/prism/issues](https://github.com/chemicoholic21/prism/issues) with the **`bug`** label and include:
...
**3. No node_modules in git** — Ever. The `.gitignore` enforces this. If you're seeing node_modules tracked, fix it before opening a PR.
...
Open a [GitHub Discussion](https://github.com/chemicoholic21/prism/discussions) or file an issue.
